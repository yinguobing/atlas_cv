...
# enType 0
ENTYPE_H265_MAIN = 0  # 0 H265 main level
ENTYPE_H264_BASE = 1  # 1 H264 baseline level
ENTYPE_H264_MAIN = 2  # 2 H264 main level
ENTYPE_H264_HIGH = 3  # 3 H264 high level

AV_CODEC_ID_H264 = 27  # h264 stream codec id
AV_CODEC_ID_HEVC = 173  # h265 stream codec id
FF_PROFILE_H264_BASELINE = 66  # h264 baseline level
FF_PROFILE_H264_MAIN = 77  # h264 main level profile
FF_PROFILE_H264_HIGH = 100  # h264 high level profile
FF_PROFILE_HEVC_MAIN = 1  # h265 main level profile
